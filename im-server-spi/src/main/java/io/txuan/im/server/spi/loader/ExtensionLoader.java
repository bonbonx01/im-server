...
public class ExtensionLoader<T>{
    ...
    private static final String TXUAN_DIRECTORY = "META-INF/txuan/";
    private static final String TXUAN_DIRECTORY_EXTERNAL = "META-INF/txuan/external/";
    private static final String TXUAN_DIRECTORY_INTERNAL = "META-INF/txuan/internal/";

    private static final String[] SPI_DIRECTORIES = new String[]{
            SERVICES_DIRECTORY,
            TXUAN_DIRECTORY,
            TXUAN_DIRECTORY_EXTERNAL,
            TXUAN_DIRECTORY_INTERNAL
    };
